...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import METIS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d00139f3-1899-568f-a2f0-47f597d42d70"))
